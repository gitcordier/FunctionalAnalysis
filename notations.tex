...
\end{equation}
%
are easily derived from the definitions of these norms, except for the case $C_{2, 1} = \sqrt{n}$, which requires the Cauchy-Schwarz inequality; %
see (1) in \citeFA{12.2}. The table below records these sharp $C_{i,j}$:
%
...
\end{equation}
%
for all measurable sets $E$. This justifies the following definition of the Lebesgue integral:
%
...
\end{equation}
%
Moreover, given $N = N(\beta)$ denoting $\set{f}{f = 0 \;\,\beta\text{-a.e.}}$, we see that the \emph{density} $f$ and the %
