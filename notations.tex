...
%
\begin{equation}
  \normtriple{W}{w} \leq C \normtriple{Y}{y} \qquad\left( w = h(y) \right), 
\end{equation}
%
...
Cauchy-Schwarz inequality; see (1) in \citeFA{12.2}. The table below records such sharp constants $C_{i,j}$,
%
