...
So ends the proof. %
%: (e)
\item Let $A$ range over a collection $\Gamma$ of balanced subsets, so that %
%
\begin{equation}
  \alpha \bigcap \Gamma \subset \alpha A \subset A \subset \bigcup \Gamma
\end{equation}
%
for all scalars $\alpha$ of magnitude $\leq 1$. %
The inclusion $\alpha \bigcap \Gamma \subset A$ establishes the first part. %
Now remark that %
%
\begin{equation}
  \alpha A  \subset \bigcup \Gamma
\end{equation}
%
implies %
%
\begin{equation}
  \alpha \bigcup \Gamma \subset \bigcup \Gamma;
\end{equation}
which completes the proof. %
%
%: (f)
\item Let $A$ range over $\Gamma$, a collection of convex subsets, so that %
%
\begin{equation}
  (s+t) \bigcap \Gamma \subset s\bigcap \Gamma + t\bigcap \Gamma \subset sA + tA 
  \overset{(d)}{\subset} (s+t)A
\end{equation}
%
for all positives scalars $s$ and $t$. Inclusions at both extremities force %
%
\begin{equation}
  s\bigcap \Gamma + t\bigcap \Gamma = (s+t) \bigcap \Gamma.
\end{equation}
%
