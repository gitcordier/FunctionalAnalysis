...
\end{equation}
%
is therefore a local base for a topology $\tau$ on $X$, see Theorem \citeFA{1.37}. Hence %
%
\begin{equation}
  %
...
\end{equation}
%
see [I.\ref{Iverson-notation}] for Iverson bracket notation. Now assume that $\singleton{f_n}$ $\tau$-converges to some $f$. %
By definition, %
%
\begin{equation}
  %
...
%
\begin{align}
  \phi: \set{\theta_n}{\theta_n \xrightarrow{n\infty} 0} & \to [0, 1] \\
...
\def\bin{\sigma}
\begin{align}
  \bin:  \set{\beta \in \{0, 1\}^{\N_+}}{\beta \text{ is not eventually periodic}} & \to [0, 1] \setminus \Q \\
