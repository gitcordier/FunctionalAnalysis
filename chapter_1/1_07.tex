...
\end{equation}
%
is a local base for a topology $\tau$ on $X$, see Theorem \citeFA{1.37}. Additionally, note that events %
$f_n \in \cup_{i=1}^m S_i$ can be bounded by summing as follows:
%
\begin{equation}
  %
...
$\singleton{\gamma_{n_k}}$ that causes $\singleton{\gamma_{n_k}f_{n_k}} \to \infty$, which proves (b). 
\end{proof}
%
% END
