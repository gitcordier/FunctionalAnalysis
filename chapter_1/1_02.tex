...
\end{equation}
%
In other words, $\co(A)$ is convex (hence $(iv) \to (i)$). We now prove that $(i)\to(ii)\to(iii)\to(iv)$ to establish the %
second property as a consequence of $(i) \to (iv)$. 
...
\begin{equation}
  \co(A) \subset \co(B) = B; 
\end{equation}
where $\subset$ expresses the covariance $A \subset B \; \then \;\co(A) \subset \co(B)$. In conclusion,
% 
\begin{equation}
  \bigcap \Gamma \subset \co(A) \subset B \qquad (B \in \Gamma),
\end{equation} 
%
