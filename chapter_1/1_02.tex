...
\end{equation}
%
In other words, $\co(A)$ is convex (the case $A=\emptyset = \co(A)$ is trivial). Note that $A$ is convex when $A = \co(A)$. %
Hence $(iv) \to (i)$. We now prove that $(i)\to(ii)\to(iii)\to(iv)$.

A proof by induction shows that $(i) \to (ii)$, as \eqref{Exercise-1-d} provides the initial case $n=2$.%
Next, (iii) is a special case of (ii), and $(iii) \to (iv)$ derives from the definition of the convex hull. %
It remains to establish the second property.
...
\begin{equation}
  \co(A) \subset \co(B) = B.
\end{equation}
The LHS inequality follows from the obvious covariance $A \subset B \; \then \;\co(A) \subset \co(B)$. %
In conclusion,
% 
\begin{equation}
