...
%
It follows that there exists a positive scalar $s$ such that
%
\begin{equation}
...
%
\begin{equation}
A+B \subset  rU + sU \subset tU + tU \subset tV \qquad (t > r, s), 
\end{equation}
%
...
there exists $V=V(a)$ a neighborhood of the origin such that %
%
...
%
%:(f)
\item The final proof consists of exhibiting a counterexample. %
