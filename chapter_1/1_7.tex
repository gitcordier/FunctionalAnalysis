...
\end{align}
%
Now assume that $\singleton{f_n}$ $\tau$-converges to some $f$, \ie 
%
\begin{align}
  %
...
\end{align}
%
The special case $W = V(x, k)$ means that, for any $k$, $\magnitude{f_n(x) - f(x)} < 2^{\minus k}$ for almost all $n$. %
In other words, $\singleton{f_n(x)}$ converges to $f(x)$. %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% B. tau-divergence => pointwise divergence. 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
Conversely, assume that $\singleton{f_n}$ does not $\tau$-converge in $X$, \ie %
%
\begin{align}
  %
  \label{Divergence}
...
\end{align}
%
$W$ is then the intersection of finitely many $V(x_1, k_1), \dots, V(x_m, k_m)$. Hence %
%
\begin{align}
  \infty 
...
\end{align}
%
for some $i$. In other words, $\singleton{f_n(x_i)}$ fails to converge to $f(x_i)$. The overall conclusion is that %
$\tau$-convergence is $X$'s version of pointwise convergence.%
\end{proof}
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% SECOND PART
...
%
  $x_\gamma %
  = \varphi^{\minus 1}\Bigl( 1 / \sqrt{1 + \magnitude{\gamma_1}}, \dots,1 / \sqrt{1 + \magnitude{\gamma_n}}, \dots\Bigr)$ %
%
implies %
%
\begin{align}
...
\end{align}
%
Now pick an arbitrary $\gamma_n \to \infty$: Given a positive integer $k$, $\gamma_n > 4^k$ for all sufficiently large $n$, %
say $n > \tilde{n}$. Next, choose $n_k > \tilde{n}$ from $\singleton{\tilde{n}}$ so large that %
%
\begin{align}
...
\end{align}
%
As a conclusion, every $\gamma_n \to\infty$ contains a subsequence $\singleton{\gamma_{n_k}}$ that keeps %
$\gamma_{n_k} f_{n_k}(v)$ away from $0$ (for some $v=v_\gamma$) when $k \to \infty$. This is (b). 
\end{proof}
%
% END
