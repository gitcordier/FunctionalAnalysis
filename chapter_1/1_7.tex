...
Indeed, the hint suggests that there exists a one-to-one and onto mapping %  
%
\begin{align}
...
\end{align}
%
provided a sequence $\singleton{\gamma_n}$ that tends to $\infty$. This proves (b), since %
...
\end{align}
%
Finally, take this special $\beta$ so that combining (\ref{definition of f_n(alpha)}) with (\ref{p sum of bits}) yields %
%
\begin{align}
...
$\singleton{\gamma_{n_k}}$ that makes $\singleton{\gamma_{n_k}f_{n_k}}$ diverge. This is (b). 
\end{proof}
%
% END
