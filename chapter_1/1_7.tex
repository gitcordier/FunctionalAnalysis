...
\end{equation}
%
Now assume that $\singleton{f_n}$ $\tau$-converges to some $f$. By definition, %
%
\begin{equation}
  %
...
%
\begin{align}
  \phi: \setbig{\theta_n}{\theta_n \xrightarrow{n\infty} 0} & \to [0, 1] \\
...
\def\bin{\sigma}
\begin{align}
  \bin:  \setbig{\beta \in \{0, 1\}^{\N_+}}{\beta \text{ is not eventually periodic}} & \to [0, 1] \setminus \Q \\
