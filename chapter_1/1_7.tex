...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
Conversely, assume that $\singleton{f_n}$ does not $\tau$-converge; that is, for any $f \in X$, there exist finitely many %
...
\end{align}
%
In (\ref{Inequality boolean series}), the special case $g_n = f_n - f$ and $U_i = V(x_i, k_i)$ then gives%
%
\begin{align}
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
\subsection{Proof with binary expansions (no hint)}
We rely on the following simple proposition: Every irrational number has an eventually aperiodic binary expansion. %
%
\begin{proof}
...
\begin{align}
  \label{definition of f_n(alpha)} f_n(x) \Def \begin{cases} 
    2^{\minus (\beta_1 + \cdots + \beta_n)} & \bigr(x = \bin(\beta_1, \dots, \beta_n, \dots) \text{ is irrational}) \\
    0 & (x \in \Q).
  \end{cases} 
\end{align}
%
