...
%
  ...
  \end{equation}
%
Note that $\Lambda(V)$ is balanced as well. Moreover, the surjectivity of $\Lambda$ ensures a vector $x_e$ such that %
...
%
  ...
  \end{equation}
%
This establishes (a) when $Y$ is $\C^n$ equipped with $\norm[\infty]{\cdot}$ and the standard basis ($B$). The general case %
