...
(e) with (g) demonstrates that $U$ is convex and balanced. To show that $U$ is a vector subspace, we note that the total %
$\subset$-ordering of $\Gamma$ implies
%
\begin{equation}
  Y_1 + Y_2  \subset \max(Y_1, Y_2),
\end{equation}
%
for all $Y_i \in \Gamma$. Hence%
%
\begin{equation}
  U + U \subset U.
\end{equation}
...
(h) and (i) imply that $Y_1 + Y_2$ is convex balanced as well. Moreover, 
%
\begin{equation}
