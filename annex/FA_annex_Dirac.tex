...
%
\begin{equation}
  \int_{\R} \heuristic{dH} = 1, \quad \heuristic{\frac{dH}{dt}} =
  \begin{cases}
  \infty & t = 0 \\
  0 & t \neq 0
  \end{cases}
...
dominated convergence theorem justifies
%
\begin{equation}
  \sup_\phi \int_{\R} \phi \diff{\delta} = \int_{\interior{W}} \diff{\delta} = \Iverson[\big]{0 \in \interior{W}}.
\end{equation}
%
...
Nevertheless, we obtain all filtered responses as the evaluation functional $\phi \mapsto \phi(0)$. This motivates the %
