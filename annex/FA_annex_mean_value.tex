...
In all cases, $Q_\omega(t) \to \infty$ when $\omega \to \infty$\ie $\sup\set{Q_\omega(t)}{\omega> 1}=\infty$ at arbitrary $t$. 
This example rules out any general inequality in the reversed direction. However, the following smooth example $\phi$ %
maintains constant derivative $\phi'$ around $0$, which is the simplest possible behavior. \par\noindent%
%
