...
%
  \begin{enumerate}
    \item{%
      ...
      Prove that there is a nonconstant functional $\Lambda$ such that %
...
We now proceed as in the proof of the Hahn-Banach theorem \citeFA{3.4} %
to establish the existence of a functional %
%
...
%
  \begin{align}
    \Lambda a -\Lambda b + 1 =\Lambda (a-b+ b_0-x_0) \leq p (a-b+ b_0-x_0) \leq 1\qquad (a\in A, b \in B).
  \end{align}
%
Hence %
%
...
%\begin{align}
%y_1=\Lambda b_1 < \Lambda \left( \frac{1}{2} a_1\right ) + \Lambda \left( \frac{1}{2} a_2\right ) = \frac{1}{2} (y_1+y_2)  \qquad .
%\end{align}
%
  \begin{align}\label{3_3_5}
    2\cdot y_1= \Lambda b_1+  \Lambda b_1 < \Lambda ( a_1 + a_2) = (y_1+y_2)  \qquad .
  \end{align}
%
...
%
  \begin{align}
  \Lambda b_1 \overset{(\ref{3_3_5})}{<}  \Lambda a_3 \overset{(\ref{3_3_3})}{\leq} \Lambda b_1\qquad ;
  \end{align}
%
...
%
  ...
  compact/closed and apply \citeFA{1.10} or \citebook{2.5}{BigRudin}.
}: %
...
In other words, $L$ is the null space of a functional %
%
  $\Lambda: \R^2\to \R$ %
%
