...
D^{\,\minus \alpha} \phi \in \mathscr{D}(\Omega):\, D^{\,\alpha} D^{\,\minus \alpha} \phi= \phi\qquad .
\end{align}
...
f- W_{m,\, k(\!m)}  \in U_m \Def \{ \phi \in \mathscr{D}_S :\, \| \phi \|_m< 1/m \} \supseteq  U_{m+1}\supseteq  \dotsb \qquad( m=1,\, 2,\, 3,\, \dots) \qquad  .
\end{align}
Pick $W$ in $\beta$ (see (b) of [6.3]): $W\cap\mathscr{D}_S$ contains a neighborhood of $0$. Hence $W$ contains some $U_{m\,}$, for $m$ sufficiently large. Thus 
\begin{align}\label{6_1_9}
W_{m,\, k(\!m) } \underset{m\infty} {\longrightarrow} f  \qquad  (\text{in } \mathscr{D}(\Omega))\qquad .
\end{align}
