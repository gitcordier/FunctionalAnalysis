...
%
  \begin{align}
    {f_n}': \D_K &\to \C\\
                    \phi &\mapsto \minus \bra{f_n}\ket{\varphi'}. \nonumber
  \end{align}
%
...
%
with $\varphi'$ and so obtain %
%
  \begin{align}
    \minus \bra{f_n}\ket{\varphi'} &\tendsto{n}{\infty} \frac{4}{3} \varphi''(0)
    \quad(\phi \in \D_K), \nonumber
  \end{align}
%
\ie %
...
%
  \begin{align}
  \lvert \bra{f_n}\ket{\varphi'} \rvert 
    \leq 
  \frac{4}{3} \norma{\infty}{ \varphi''} \quad (\counting{n}).
  \end{align}
%
...
%
  \begin{align}
    \lvert \langle f_n \lvert \varphi' \rangle \rvert 
      \leq 
    M \norma{\infty}{\varphi'} 
    \quad (\counting{n}).
  \end{align}
...
%
  \begin{align}
    \lvert 
      \langle \lvert f_n \varphi'\rangle
    \rvert 
      \leq 
    M \norma{\infty}{\varphi'}
    \quad (\counting{n}).
