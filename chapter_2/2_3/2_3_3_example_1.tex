...
%
  \begin{align}\label{2.3. Mean value inequality (concrete).}
    \magnitude{ \phi(1/n) - \phi(\minus 1/n)} 
      \leq 
    \Beta_{n}(\varphi')\magnitude{1/n - ({\minus}1/n)} 
      = 
    \frac{2}{n} \Beta_{n}(\varphi').
    %
  \end{align}
%
  ...
  \begin{align}
    \bra{f_n}\ket{\phi}
      & =  
        ...
        - \frac{n^3}{2} \int_{\minus 1/n}^{1/n} t^{2} \varphi'(t)dt\\ 
      %
  ...
  \begin{align}
    ...
    & \leq  
      \frac{n}{2}\magnitude{\phi(1/n) - \phi(\minus 1/n)}
        + 
      \frac{n^3}{2}\int_{\minus1/n}^{1/n} t^{2}\lvert\varphi'(t)\rvert dt
      \\
    %
      & \leq  
        \Beta_{n}(\varphi') 
          + 
        \frac{n^3}{2} \Beta_{n}(\varphi') \int_{\minus1/n}^{1/n} t^{2} dt \\
      %
      \label{2.3. Bound with p and M (M_n).}
      & \leq 
      \frac{4}{3} \Beta_{n}(\varphi') \\
...
%
  $\Beta_{n}(\varphi')$ tends to $\magnitude{\varphi'(0)}$, %
%
we may expect that %
%
  $f_n$ tends to $\frac{4}{3}\varphi'(0)$. %
%
This is actually true: A straightforward computation shows that %
%
  \begin{align}
    \bra{f_n}\ket{\phi} - \frac{4}{3}\varphi'(0)
      \citeq{\ref{2.3. Equality from integration by parts.}} 
    \frac{\phi(1/n) - \phi(\minus 1/n)}{1/n - (\minus 1/n)}
    - \varphi'(0)
    - \frac{n^3}{2} \int_{\minus 1/n}^{1/n} (\varphi' - \varphi'(0)) t^{2} dt.
  \end{align}
%
So, 
%
  \begin{align}
    \magnitude{\bra{f_n}\ket{\phi} -\frac{4}{3} \varphi'(0)} 
      & \leq 
    \magnitude{
      \frac{\phi(1/n) - \phi(\minus 1/n)}{1/n - (\minus 1/n)}
      - \varphi'(0)
    }
    + \frac{1}{3}\Delta_{n}(\varphi') 
    % 
    \tendsto{n}{\infty} 0.
  \end{align}
%
