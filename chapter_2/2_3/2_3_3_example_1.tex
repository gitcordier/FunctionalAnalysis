...
From now on, $f_n(x) = n^3 x \Iverson{\minus 1/n \leq x \leq 1/n}$. %
Actually, we will prove that 
%
\renewcommand{\labelenumi}{(\alph{enumi})}
%
\begin{enumerate}
  \item{$\int_K f_n \phi \tendsto{n}{\infty} \Lambda \phi \quad (\phi\in\D_{K})$,}
  \item{A uniform bound %
    %
      $\magnitude{\Lambda_n} \leq M \norma{\infty}{D^p }$ %
    %
    exists for all $f_n$, with $p=1$ as the smallest possible $p$.
  }
\end{enumerate}
  %
...
%
  \begin{align}
    \Mu_{n}(\zeta) 
      & 
      \Def \max_{[\minus 1/n , 1/n]}  \magnitude{\zeta}\\
        %\Def  \max\set{\magnitude{\phi(x)}}{x \in [\minus 1/n, 1/n]}, \\
    %
    \Delta_{n}(\zeta) & \Def \max_{[\minus 1/n , 1/n]} \magnitude{\zeta - \zeta(0)}
    %\Delta_{n}(\phi) 
      %& 
        %\Def  \max\set{\magnitude{\phi(x) - \phi(0)}}{x \in [\minus 1/n, 1/n]}. 
  \end{align}
%
for all $\zeta \in \D_K$. Next, we easily establish the following mean value inequality, 
%
  ...
  \begin{align}
    ...
    %
      & \leq  
        \Mu_{n}(\phi') 
          + 
        \frac{n^3}{2} \Mu_{n}(\phi') \int_{\minus1/n}^{1/n} t^{2} dt \\
      %
...
%
  $\Mu_{n}(\phi')$ tends to $\magnitude{\phi'(0)}$, %
%
we may expect that %
%
...
%
  \begin{align}
    \magnitude{\Lambda_n\phi -\frac{4}{3} \phi'(0)} 
      & \leq 
    \magnitude{
      \frac{\phi(1/n) - \phi(\minus 1/n)}{1/n - (\minus 1/n)}
      - \phi'(0)
...
%
  \begin{align}\label{2.3. (f_n) converges to Dirac (1).}
    \Lambda_n\phi \tendsto{n}{\infty} %\Lambda\phi \Def 
    \frac{4}{3}\phi'(0) 
    %
...
%
  \begin{align}
    \Lambda_n \tendsto{n}{\infty}\minus \frac{4}{3}\delta' ,
  \end{align}
%
...
%
  \begin{align}
    \lvert \Lambda_n\phi \rvert \leq \frac{4}{3} \norma{\infty}{\phi'} 
    \quad (\counting{n}) 
  \end{align}
%
(which is a concrete version of %
%
