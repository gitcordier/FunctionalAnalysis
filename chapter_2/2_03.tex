...
in $C(\R)$. Each density $f_n$ is then identified with the following %
%
\begin{align}
...
\end{align}
%
seen as with a Radon measure. Every $\Lambda_n$ is continuous since $\norm{\Lambda_n}=\norm[1]{f_n}$ is finite; %
...
\begin{align}
  ...
  \big\lvert\hspace{0.15em}\Lambda_n \phi \phantom{,}\big\rvert &\leq M \norm[\infty]{\phi'} \label{2.3-norm-p-bound1},\\
