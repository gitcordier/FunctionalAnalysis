...
which reduces to $\magnitude*{\Lambda_n \phi} \leq  p\norm*[p]{\phi}$. Applying Lemma [\ref{annex:mean-value-with-derivatives}] with %
...
It is a standard smooth approximation of $H:t\mapsto \Iverson*{t\geq 0}$, the Heaviside step function; %
see [\ref{annex-Dirac}]. Thus, Lebesgue's dominated convergence theorem implies
%
\begin{equation}
