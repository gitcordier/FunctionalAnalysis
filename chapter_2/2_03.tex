...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
Equipped with the supremum norm, $\Continuous_K=C(\R) \cap \set{\phi}{\supp\phi\subset K}$ is $C(\R)$'s copy of $C_c(K)$. %
...
\end{equation}
%
We refer to \citeFA{6.19} for a more general scope. A first point is that is there is no vague convergence for the current %
...
\begin{equation}
  ...
  - \underbrace{\tilde{\phi}(\minus 1 /n)}_{\minus 1}\,\bigr) 
