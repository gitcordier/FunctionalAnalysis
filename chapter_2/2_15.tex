...
%
for all positive integers $n$. First, let $x$ range over $X$ so that $x + V_n$ is open and dense as well (because%
\footnote{
...
\begin{enumerate}
  ...
  \item so is the (then nonempty) intersection $\bigcap_{n=1}^\infty W_n$.
\end{enumerate}
%
Moreover, the intersection $\bigcap_{n=1}^\infty V_n$ cuts no $E_n$. To sum up, %
%
