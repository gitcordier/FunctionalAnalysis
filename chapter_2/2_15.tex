...
% A. Assumptions.
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
Let $\set{E_n}{\counting{n}}$ whose union is $X\setminus Y$. More specifically, assume that every $E_n$ is nowhere dense\ie %
$V_n = X \setminus \closure{E_n}$ is dense in $X$. Now pick an arbitrary $x \in X$. Since the translation by $x$ is a %
self-homeomorphism, $x + V_n$ is open and dense as well%
%
