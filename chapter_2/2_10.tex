...
spaces. This implies that, for any balanced neighborhood $W$, there exists a balanced open set $U_i \subset X_i$ such that %
%
\begin{align}
  B(U_1 \times U_2) \subset W. 
\end{align}
%
Pick $a_i$ from $ X_i$, and then choose $r_i > 1$ large enough so that $a_i \in r_i U_i$. The vector $b_i - a_i$ is now %
...
\end{align}
%
(the inclusions derive from the balancedness of $U_i$ and $W$). We conclude that $B$ is continuous at every %
$(a_1, a_2)$, since $W$ was arbitrary. This concludes the proof. 
\end{proof}
%END