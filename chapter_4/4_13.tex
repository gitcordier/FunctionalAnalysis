...
T(U\,)\subset \bigcup_{c\in C} B(c,\, \epsilon)\quad .
\end{align}
...
\end{align}
by [12.4]. There so exists a unique projection $\pi=\pi(\epsilon)$ of $Y$ onto itself (see [5.6] for the definition) such that
\begin{align}
