...
\end{align}
As a Hilbert space, $Y$ contains a \textsl{maximal orthonormal set} (or \textsl{Hilbert basis}) $M$. This implies that $\text{span}(M)$ is dense in $Y$; \cf 4.18 \& 4.22 of \cite{BigRudin}. The finiteness of $C$ forces $M$ to enclose a finite set $S$ so that 
