...
\begin{align}
U=\phi^{\minus 1} \left(V \cap \phi(X\,) \right) = \phi^{\minus 1} (V)  \cap X \qquad ( V\in \mathscr{S}_\sigma\,,\,\,U\in \mathscr{S}_\tau) \qquad ,
\end{align}
...
\begin{align}
\lvert \, \psi y^{\,\ast}\,   \rvert \leq 1 \text{  on }\phi(B\,)\, , \, \, \ie \lvert\, y^{\,\ast}  \, \rvert \leq 1  \text{  on } B\qquad .
\end{align}
