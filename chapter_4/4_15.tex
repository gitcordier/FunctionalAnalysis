...
\begin{align}
\langle u ,\, f^{\,\,\ast}  \rangle =\int_\Omega u\cdot f \, \diff\mu  \quad (u\in X,\, f\in X)\quad .
\end{align}
...
\begin{align}
\int_\Omega a_i (s\,) \cdot b_i \cdot f  \,\,\diff\mu \,\,\in \C\cdot  a_i(s\,)\,\,\,\text{a.e}\quad \quad (f\in X, \, s\in \Omega)  \quad.
\end{align}
...
\begin{align}
A(s\,)\Def \int_\Omega \lvert K_s(t\,) \cdot u (t\,)\rvert  \,\, \diff\mu(t\,) \, \,\,\text{a.e}  \quad (s\in \Omega)\quad ,
\end{align}
