...
% --------------------------- TEXT FONTS ----------------------------
% Note: If you want to strictly forbid italics even in text 
% (e.g. \textit produces upright text), set ItalicFont to the Regular .otf file.
%\setmainfont[
...
% Correction for typewriter math
%\setmathfont[range=\mathtt]{NewCMMono10-Book.otf}

 % Load the main math font

 %\setmathfont{New Computer Modern Math}


 % 2. CORRECTION: \setmathtt is not a command in unicode-math.
 
 % Use range=\mathtt to set the typewriter math font.
 
 \setmathfont[range=\mathtt]{cmuntt.otf}
...
\newcommand\usualSet[1]{\mathbf{#1}} % UPDATED for unicode-math
\def\C{\usualSet{C}}
\def\R{\usualSet{R}}
\def\Q{\usualSet{Q}}
\def\Z{\usualSet{Z}}
...
%\newcommand{\singleton}[2][\big]{#1\{#2 #1\}}
